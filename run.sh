...
EOF
  ...
  (
    WERCKER_DOCSET_PUBLISH_ORIG_AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID
    WERCKER_DOCSET_PUBLISH_ORIG_AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY
    WERCKER_DOCSET_PUBLISH_ORIG_AWS_SESSION_TOKEN=$AWS_SESSION_TOKEN

    export AWS_ACCESS_KEY_ID=$WERCKER_DOCSET_PUBLISH_AWS_ACCESS_KEY_ID
    export AWS_SECRET_ACCESS_KEY=$WERCKER_DOCSET_PUBLISH_AWS_SECRET_ACCESS_KEY
    if [ ! -z $WERCKER_DOCSET_PUBLISH_AWS_SESSION_TOKEN ]; then
      export AWS_SESSION_TOKEN=$WERCKER_DOCSET_PUBLISH_AWS_SESSION_TOKEN
    fi
    ...
    export AWS_ACCESS_KEY_ID=$WERCKER_DOCSET_PUBLISH_ORIG_AWS_ACCESS_KEY_ID
    export AWS_SECRET_ACCESS_KEY=$WERCKER_DOCSET_PUBLISH_ORIG_AWS_SECRET_ACCESS_KEY
    export AWS_SESSION_TOKEN=$WERCKER_DOCSET_PUBLISH_ORIG_AWS_SESSION_TOKEN
  )
}
